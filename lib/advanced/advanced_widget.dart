...
import 'advanced_model.dart';
export 'advanced_model.dart';
...
class _AdvancedWidgetState extends State<AdvancedWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdvancedModel());
  }
                        ...
                        itemBuilder: (context, index) {
                          return [
                            () => ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://mun.lumifica.net/wp-content/uploads/2023/07/image_2023-07-16_001304452.png',
                                    width: 120.0,
                                    height: 120.0,
                                    fit: BoxFit.cover,
                                  ),
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('chooser');
                          },
                          text: 'Update Attendee List',
