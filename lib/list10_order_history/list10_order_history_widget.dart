...
class List10OrderHistoryWidget extends StatefulWidget {
  const List10OrderHistoryWidget({
    Key? key,
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Below are all found matching names',
                ...
                Padding(
                  ...
                  child: FutureBuilder<List<AttendanceRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<AttendanceRow> columnAttendanceRowList =
                          snapshot.data!;
                      return Column(
                        mainAxisSize: MainAxisSize.max,
                        children: List.generate(columnAttendanceRowList.length,
                            (columnIndex) {
                          final columnAttendanceRow =
                              columnAttendanceRowList[columnIndex];
                          return Padding(
