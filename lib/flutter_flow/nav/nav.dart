          ...
          routes: [
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Details01ProjectTracker')
                  : Details01ProjectTrackerWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              builder: (context, params) => Details11EventTicketWidget(
                passing: params.getParam<AttendanceRow>(
                    'passing', ParamType.SupabaseRow),
              ),
            ),
            FFRoute(
              name: 'commiteesort',
            ...
            FFRoute(
              ...
              path: 'advanced',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'advanced')
                  : AdvancedWidget(),
            ),
            FFRoute(
              name: 'chooser',
              path: 'chooser',
              builder: (context, params) => ChooserWidget(),
            ),
            FFRoute(
              name: 'addattendebt',
              path: 'addattendebt',
              builder: (context, params) => AddattendebtWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'commiteesortCopy',
              builder: (context, params) => CommiteesortCopyWidget(),
            )
